...
<form method='GET' action='/search'>
    ...
    <fieldset>
        ...
        <input type='radio' name='searchType' id='title' value='title' {{ (old('searchType') == 'title' or $searchType == 'title') ? 'checked' : ''}}>
        <label for='title'> Title</label>

        <input type='radio' name='searchType' id='author' value='author' {{ (old('searchType') == 'author' or $searchType == 'author') ? 'checked' : ''}}>
