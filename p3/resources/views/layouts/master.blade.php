...
<head>
    ...
    <script src="https://kit.fontawesome.com/85d698d598.js" crossorigin="anonymous"></script>
...
<body>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <!-- Bottom Left -->
                <div class="col-2"><a href="/bloomz">
                        <img src="../images/icons/bloomz-icon.png" style="width:40px; float:left;"></a>
                </div>
                <!-- Bottom Middle -->
                <div class="col-8">
                    <h5>Our School</h5>
